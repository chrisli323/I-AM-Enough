...
enum Theme {
    ...
    /// Faded ink darkened 15% — used for the Day N header and tab bar selected tint.
    static let inkFadedDark = Color(uiColor: UIColor(red: 0.493, green: 0.383, blue: 0.210, alpha: 1)) // #7E6235
